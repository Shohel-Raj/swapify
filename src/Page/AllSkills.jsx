            ...
            >
              ...
              <div className="p-5 flex flex-col flex-1">
                ...
                <div className="flex justify-between items-center mt-4">
                  ...
                  <button className="px-4 py-2 text-blue-600 border border-blue-600 rounded-full text-sm font-medium hover:bg-blue-50 hover:scale-105 transition-all duration-300">
                    View Details
                  </button>
                </div>
              </div>
